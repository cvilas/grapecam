...
public:
  ...
  bool addOption(int opt, OptionType type, const char* help, const char* name = nullptr,
                 OptionArgument argument = ArgumentNone, const char* argumentName = nullptr,
                 bool array = false, int parent = 0);
  bool addOption(int opt, KeyValueParser* parser, const char* help, const char* name = nullptr,
                 bool array = false, int parent = 0);
...
private:
  ...
  std::tuple<OptionsParser::Options*, const Option*> childOption(const Option* parent,
                                                                 Options* options);
...
public:
  ...
  bool empty() const {
    return type_ == ValueType::ValueNone;
  }
